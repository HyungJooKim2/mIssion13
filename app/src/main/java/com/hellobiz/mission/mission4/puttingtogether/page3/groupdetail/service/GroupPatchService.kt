...
class GroupPatchService(groupPatch: GroupPatch) {
    ...
    fun getGroupPatchService(memId: Int, memType: String, page: Int) {
        ...
        */
        ...
        groupPatchInterface.patchGroupData(memId, memType, page).enqueue(object : Callback<GroupPatchModel?> {
